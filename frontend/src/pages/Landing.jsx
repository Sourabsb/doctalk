...
const Landing = () => {
  ...
  const features = [
    { 
      ...
      desc: 'Upload PDFs, DOC, TXT, images, and more. All your documents processed seamlessly.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
      ),
      visual: ['PDF', 'DOC', 'TXT', 'IMG']
    },
    { 
    ...
    { 
      ...
      desc: 'Speak your questions and listen to answers. Hands-free document interaction.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    { 
      ...
      desc: 'Regenerate and compare multiple AI responses. Pick the best answer.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex gap-3 items-end">
                      {['V1', 'V2', 'V3'].map((v, i) => {
                        ...
                        return (
                          <div 
                            key={v}
                            className={`w-14 rounded-xl border flex flex-col items-center justify-center text-xs font-medium transition-all duration-300 ${
                              isActive 
